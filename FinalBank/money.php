...
<body>
                ...
                <ul class="navbar-nav me-auto mb-8 mb-lg-0">
                    ...
                    <li class="nav-item dropdown py-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item py-3" href="#">View all Customers</a></li>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/m1.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Customer Details</strong> <img src="logos/m2.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>

    <!-- options -->
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        <a href="history.php"><button type="button" class="btn btn-primary btn-lg mb-3">View Transaction History ></button></a>
    </div>
    </div>

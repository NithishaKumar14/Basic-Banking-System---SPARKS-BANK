                ...
                <ul class="navbar-nav me-auto mb-8 mb-lg-0">
                    ...
                    <li class="nav-item dropdown py-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item py-3" href="money.php">View all Customers</a></li>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/piggybank.jpg" width="1000" height="630" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="background/DigiB.jpg" width="1000" height="630" class="d-block w-100" alt="...">
